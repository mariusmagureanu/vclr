...
var (
	...
	variables = map[string][]string{
		...
		"req.hash":             []string{"vcl_hit", "vcl_miss", "vcl_pass", "vcl_purge", "vcl_deliver"},
		...
		"bereq.body":                  []string{"vcl_backend_fetch"},
		...
		"beresp":              []string{"vcl_backend_response", "vcl_backend_error"},
		"beresp.body":         []string{"vcl_backend_error"},
		"beresp.proto":        []string{"vcl_backend_response", "vcl_backend_error"},
		"beresp.status":       []string{"vcl_backend_response", "vcl_backend_error"},
		"beresp.reason":       []string{"vcl_backend_response", "vcl_backend_error"},
		"beresp.http.*":       []string{"vcl_backend_response", "vcl_backend_error"},
		"beresp.do_esi":       []string{"vcl_backend_response", "vcl_backend_error"},
		"beresp.do_stream":    []string{"vcl_backend_response", "vcl_backend_error"},
		"beresp.do_gzip":      []string{"vcl_backend_response", "vcl_backend_error"},
		"beresp.do_gunzip":    []string{"vcl_backend_response", "vcl_backend_error"},
		"beresp.was_304":      []string{"vcl_backend_response", "vcl_backend_error"},
		"beresp.uncacheable":  []string{"vcl_backend_response", "vcl_backend_error"},
		"beresp.ttl":          []string{"vcl_backend_response", "vcl_backend_error"},
		"beresp.age":          []string{"vcl_backend_response", "vcl_backend_error"},
		"beresp.grace":        []string{"vcl_backend_response", "vcl_backend_error"},
		"beresp.keep":         []string{"vcl_backend_response", "vcl_backend_error"},
		"beresp.backend":      []string{"vcl_backend_response", "vcl_backend_error"},
		"beresp.backend.name": []string{"vcl_backend_response", "vcl_backend_error"},
		"beresp.backend.ip":   []string{"vcl_backend_response"},
		"beresp.storage":      []string{"vcl_backend_response", "vcl_backend_error"},
		"beresp.storage_hint": []string{"vcl_backend_response", "vcl_backend_error"},
		"beresp.filters":      []string{},

		"obj.proto":       []string{"vcl_hit"},
		"obj.status":      []string{"vcl_hit"},
		"obj.reason":      []string{"vcl_hit"},
		"obj.hits":        []string{"vcl_hit", "vcl_deliver"},
		"obj.http.*":      []string{"vcl_hit"},
		"obj.ttl":         []string{"vcl_hit", "vcl_deliver"},
		"obj.age":         []string{"vcl_hit", "vcl_deliver"},
		"obj.grace":       []string{"vcl_hit", "vcl_deliver"},
		"obj.keep":        []string{"vcl_hit", "vcl_deliver"},
		"obj.uncacheable": []string{"vcl_deliver"},
		"obj.storage":     []string{"vcl_hit", "vcl_deliver"},

		"resp.body":         []string{"vcl_synth"},
		"resp.proto":        []string{"vcl_deliver", "vcl_synth"},
		"resp.status":       []string{"vcl_deliver", "vcl_synth"},
		"resp.reason":       []string{"vcl_deliver", "vcl_synth"},
		"resp.http.*":       []string{"vcl_deliver", "vcl_synth"},
		"resp.do_esi":       []string{"vcl_deliver", "vcl_synth"},
		"resp.is_streaming": []string{"vcl_deliver", "vcl_synth"},
		"resp.filters":      []string{},
